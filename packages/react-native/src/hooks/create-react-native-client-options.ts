...
export function createReactNativeClientOptions<Events extends EventMap>(
  options: SSEClientOptions<Events>,
  optionsRef: { readonly current: SSEClientOptions<Events> }
...
function createEventHandlers<Events extends EventMap>(optionsRef: {
  readonly current: SSEClientOptions<Events>;
...
function createReconnectOptions<Events extends EventMap>(optionsRef: {
  readonly current: SSEClientOptions<Events>;
...
function createAuthOptions<Events extends EventMap>(optionsRef: {
  readonly current: SSEClientOptions<Events>;
...
function createDiagnosticsOptions<Events extends EventMap>(optionsRef: {
  readonly current: SSEClientOptions<Events>;
...
function createRetryOptions<Events extends EventMap>(optionsRef: {
  readonly current: SSEClientOptions<Events>;
